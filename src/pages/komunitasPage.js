...
export default function KomunitasPage() {
    return(
        <>
            ...
            <div className="w-full px-3 mt-4 md:px-16">
                <p className="mb-4">Events</p>
                <div className="flex w-full gap-4 overflow-hidden">

                    <div className="w-40 min-h-52 flex-shrink-0 bg-gray-100 rounded-sm">
                        <div className="w-full h-28">
                            <img src="https://media.nature.com/lw767/magazine-assets/d41586-023-03618-x/d41586-023-03618-x_26361588.jpg?as=webp" className="object-cover h-full w-full rounded-t-sm"></img>
                        </div>
