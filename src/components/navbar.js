...
export default function Navbar () {
    ...
    return(
        <nav className="fixed w-screen h-10 flex justify-between items-center bg-slate-400">
            <h1 className="self-center py-2 px-6 text-lg font-semibold">LetsGo-Blog</h1>
            ...
            <ul className='hidden sm:flex items-center text-base font-semibold px-6 py-2 gap-6'>
                <li className='relative'>
                    <p onClick={handleClickWisata} className="z-50">Wisata</p>
                    {wisataDrop ? (                  
