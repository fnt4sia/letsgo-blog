        ...
        <div className="flex justify-center items-center h-screen">
            <div className="bg-white p-8 rounded shadow-lg w-80">
                ...
                <form action="" className="flex flex-col gap-2 mt-6 items-center">
                    ...
                    <div className="relative w-full">
                        <input type="password" placeholder="Confirm Password" className="border-2 border-gray-200 rounded-md p-2 w-full" />
                        <FaLock className="absolute top-1/2 right-2 transform -translate-y-1/2 text-gray-400" />
                    </div>
                  
                    <button className="bg-slate-400 rounded py-3 px-16 text-white mt-6">REGISTER</button>
                </form>
