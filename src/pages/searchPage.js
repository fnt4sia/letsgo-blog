    ...
    useEffect(() => {
        ...
        return(
            <>
                ...
                <h3 class="pt-10 px-3 md:px-24 text-lg md:text-xl font-bold">Destinasi Wisata Terkait</h3>
                ...
                <div className="w-full px-3 mt-4 md:px-24">
                    <p className="pt-10 text-lg md:text-xl font-bold mb-4">Events Terkait</p>
                ...
                <div className="w-full px-3 mt-6 md:px-24">
                    <p className="pt-10 text-lg md:text-xl font-bold mb-4">Post Terkait</p>
